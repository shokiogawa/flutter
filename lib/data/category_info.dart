...
final List<Category> categories = [
  ...
  Category(categoryId: 2, nameEn: 'techonoly', nameJp: 'テクノロジー'),
  Category(categoryId: 3, nameEn: 'science', nameJp: '科学'),
  Category(categoryId: 4, nameEn: 'health', nameJp: '健康'),
  Category(categoryId: 5, nameEn: 'sportsl', nameJp: 'スポーツ'),
  Category(categoryId: 6, nameEn: 'entertainmentl', nameJp: 'エンタメ'),
];